...
//           if (user.isHealthProfileCompleted == true) {
...
//           );
//         } else {
//           // Fallback (just in case role is unexpected)
//           Navigator.pushReplacement(
//             context,
//             MaterialPageRoute(builder: (_) => const ParticipantDashboard()),
//           );
...
//                       height:
//                           150, // Adjust the height as needed, or remove to maintain aspect ratio
//                     ),
//                   ),
    ...
    try {
      ...
      if (role == "participant"){
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => ParticipantDashboard(),
          ),
        );
      }
