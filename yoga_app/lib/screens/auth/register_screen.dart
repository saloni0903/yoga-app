...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      apiService.tempEmail = _emailController.text.trim();
      apiService.tempPassword = _passwordController.text;

      // if (mounted) {
      //   ScaffoldMessenger.of(context).showSnackBar(
      //     const SnackBar(
      //       content: Text('Registration successful! Complete your health profile.'),
      ...
      if(!mounted){
        return;
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (_) => const HealthQuestionnaireScreen(),
            ),
          );
      //}
    } catch (e) {
  ...
  Future<void> _fetchLocation() async {
    ...
    try {
      ...
      // });
      setState(() {
        _locationController.text = 'Guna'; // or any default city you want
      });
    } catch (e) {
      if (mounted) {
