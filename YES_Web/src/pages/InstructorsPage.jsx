                  ...
                  <tr key={instructor._id} className={`transition-colors ${
                    ...
                    <td className="px-4 sm:px-6 py-4 text-sm space-x-2 sm:space-x-3 whitespace-nowrap">
                      {currentStatus === 'pending' && (
                        <>
                          <button
                            onClick={() => updateInstructorStatus(instructor.id, 'approved')}
                          ...
                          <button
                            onClick={() => updateInstructorStatus(instructor.id, 'rejected')}
                            className={`font-semibold hover:underline ${
                      ...
                      {currentStatus === 'approved' && (
                        <button
                          onClick={() => updateInstructorStatus(instructor.id, 'suspended')}
                          className={`font-semibold hover:underline ${
