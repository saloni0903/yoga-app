...
class _ParticipantDashboardState extends State<ParticipantDashboard> {
  ...
  // --- No changes to build() or _buildNoGroupView() ---
  @override
    ...
    return FutureBuilder<User>(
      ...
      builder: (context, snapshot) {
        ...
        if (currentUser.groupId == null) {
          ...
          // Pass the user data to the joined view
    ...
    return FutureBuilder<YogaGroup>(
      ...
      builder: (context, groupSnapshot) {
        ...
        if (groupSnapshot.hasError) {
          return Center(child: Text("Error loading your group: ${groupSnapshot.error}"));
        }
        ...
        return ListView(
          ...
          children: [
            ...
            // Scan QR Code Button
            ElevatedButton.icon(
              onPressed: () { /* TODO: Navigate to QR Scanner Screen */ },
